...
class Wpstorm_Notify_Gravity_Forms
{
    /**
     * Instance
     *
            ...
            if ($form['id'] == $form_id) {
                ...
                switch ($action) {
                    ...
                    case 'sendSmsToUser':
                        ...
                        Wpstorm_Notify_Ippanel::send_pattern($pattern, $phone_number, $input_data);
                        break;
                    case 'sendSmsToAdmin':
                        ...
                        Wpstorm_Notify_Ippanel::send_pattern($pattern, Wpstorm_Notify_Base::$admin_number, $input_data);
                        break;
                }
            }
        }
...
Wpstorm_Notify_Gravity_Forms::get_instance();
