...
class Wpstorm_Notify_Digits
{
    ...
    {
        add_action('profile_update', [$this, 'user_profile_updated'], 99, 1);
    }
    ...
    public function user_profile_updated($user_id)
    {
        ...
        Wpstorm_Notify_Base::send_welcome_message($digits_phone, $user_id);
        update_user_meta($user_id, 'sent_welcome_message', '1');
    }
}

Wpstorm_Notify_Digits::get_instance();
