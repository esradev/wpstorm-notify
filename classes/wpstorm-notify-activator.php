...
class Wpstorm_Notify_Activator
{
    ...
    public static function activate()
    {
        ...
        $newsletter_table_name     = $wpdb->prefix . 'wpstorm_notify_newsletter';
        $verify_code_table_name    = $wpdb->prefix . 'wpstorm_notify_vcode';
        $gravity_forms_table_name  = $wpdb->prefix . 'wpstorm_notify_gravity_forms';
        $tracking_codes_table_name = $wpdb->prefix . 'wpstorm_notify_tracking_codes';
        $woocommerce_orders_table_name = $wpdb->prefix . 'wpstorm_notify_woocommerce_order_actions';
...
;");
        ...
        add_option('wpstorm_notify_do_activation_redirect', true);
    }
    ...
    public static function modify_option()
    {
        ...
        $options = json_decode(get_option('wpstorm_notify_settings_options'), true);
        ...
        update_option('wpstorm_notify_settings_options', $options_json);
    }
}
