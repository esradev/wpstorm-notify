...
class Wpstorm_Notify_Base
{
    ...
    public function __construct()
    {
        ...
        $credentials_option = json_decode(get_option('wpstorm_notify_settings_options'), true);
        ...
        $phonebook_options = json_decode(get_option('wpstorm_notify_phonebook_options'), true);
     ...
     * @since 1.0.0
     */
    public static function tr_num($str)
    {
        $num_a = [
            '0',
            '1',
    ...
    public static function send_welcome_message($phone, $user_id)
    {
        ...
        if (!self::$sendwm_with_pattern) {
            ...
            Wpstorm_Notify_Ippanel::send_message([$phone], $welcome_message, '+98club');
        } else {
            $patternMessage = Wpstorm_Notify_Ippanel::get_registered_pattern_variables(self::$welcomep);
            ...
            return Wpstorm_Notify_Ippanel::send_pattern(self::$welcomep, $phone, $input_data);
        }
    }
...
Wpstorm_Notify_Base::get_instance();
