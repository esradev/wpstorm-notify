...
function Phonebook(props) {
  ...
  const originalState = {
    ...
    inputs: {
      custom_phonebook: {
        ...
        label: __("Select the custom phonebook:", "wpstorm-notify"),
        options: [],
      ...
      custom_phone_meta_keys: {
        ...
        type: "select",
        label: __("Select the mobile number custom field:", "wpstorm-notify"),
        options: [],
        noOptionsMessage: __("No options is available", "wpstorm-notify"),
      },
      ...(props.integratedPlugins.digits.use && {
        digits_phonebook: {
          ...
          type: "select_phonebook",
          label: __("Select phonebook for Digits:", "wpstorm-notify"),
          options: [],
          noOptionsMessage: __("No options is available", "wpstorm-notify"),
        },
      }),
      ...(props.integratedPlugins.woocommerce.use && {
        woo_phonebook: {
          ...
          name: "woo_phonebook",
          type: "select_phonebook",
          label: __("select a phonebook for WooCommerce:", "wpstorm-notify"),
          options: [],
          noOptionsMessage: __("No options is available", "wpstorm-notify"),
        },
      }),
      ...(props.integratedPlugins.bookly.use && {
        bookly_phonebook: {
          ...
          type: "select_phonebook",
          label: __("Choosing a phonebook for Bookly:", "wpstorm-notify"),
          options: [],
          noOptionsMessage: __("No options is available", "wpstorm-notify"),
        },
      }),
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("Phonebook", "wpstorm-notify"),
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/phonebook_options";
        ...
        <div className="container card bg-light mb-3 mt-1">
          <div className="card-body">
            <h5 className="card-title">
              {__("Special Offer:", "wpstorm-notify")}
            </h5>
            ...
            <a
              href="https://wpstorm-notify.ir/pos/"
              className="btn btn-success"
              target="_blank"
            >
              {__("Buying a mobile number storage device", "wpstorm-notify")}
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="container card bg-warning mb-3">
            <div className="card-body">
              ...
              <p className="card-text">
                {__(
                  "You have not registered a phone book yet. Please create your phone book in the wpstorm-notify panel first.",
                  "wpstorm-notify"
                )}
              </p>
            </div>
