...
function Edd(props) {
  ...
  const originalState = {
    inputs: {
      edd_phonebook: {
        ...
        label: __("Save the phone number in the phonebook?", "wpstorm-notify"),
        options: [],
      ...
      edd_send_to_user: {
        ...
        type: "checkbox",
        label: __("Send sms to the user?", "wpstorm-notify"),
      },
      edd_user_pattern: {
        value: "",
        hasErrors: false,
        ...
        type: "text",
        label: __("SMS pattern code for the user:", "wpstorm-notify"),
      ...
      edd_send_to_admin: {
        ...
        type: "checkbox",
        label: __("Send sms to the admin?", "wpstorm-notify"),
      },
      edd_admin_pattern: {
        value: "",
        hasErrors: false,
        ...
        type: "text",
        label: __("SMS pattern code for the admin:", "wpstorm-notify"),
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("Edd", "wpstorm-notify"),
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/edd_options";
