...
function Comments() {
  ...
  const originalState = {
    inputs: {
      disable_email_filed: {
        ...
        type: "checkbox",
        label: __("Remove email filed from comment form?", "wpstorm-motify"),
      },
      disable_website_filed: {
        ...
        type: "checkbox",
        label: __("Remove website filed from comment form?", "wpstorm-motify"),
      },
      disable_cookies: {
        value: "",
        hasErrors: false,
        ...
        type: "checkbox",
        label: __("Remove cookies checkbox from comment form?", "wpstorm-motify"),
      },
      add_mobile_field: {
        value: "",
        hasErrors: false,
      ...
      comment_phonebook: {
        ...
        label: __("Save the phone number in the phonebook?", "wpstorm-motify"),
        options: [],
        noOptionsMessage: __("No options is available", "wpstorm-motify"),
        isDependencyUsed: false,
      },
      comment_pattern: {
        value: "",
        ...
        type: "text",
        label: __("Comment approved pattern code:", "wpstorm-motify"),
        isDependencyUsed: false,
      },
      comment_reply_pattern: {
        ...
        type: "text",
        label: __("Comment response pattern code:", "wpstorm-motify"),
        isDependencyUsed: false,
      },
      ...
      notify_admin_for_comment_pattern: {
        ...
        type: "text",
        label: __("Admin pattern code:", "wpstorm-motify"),
        infoTitle: __("Usable variables:", "wpstorm-motify"),
        infoBody: __(
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("Comments", "wpstorm-motify"),
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-motify/v1/comments_options";
