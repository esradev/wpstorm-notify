...
function Aff(props) {
  ...
  const originalState = {
    inputs: {
      aff_user_mobile_field: {
        ...
        groupTitle: __("Users settings:", "wpstorm-notify"),
      },
      aff_user_register: {
        value: "",
        hasErrors: false,
        ...
        type: "checkbox",
        label: __("Send sms to user on registration:", "wpstorm-notify"),
      },
      aff_user_register_pattern: {
        ...
        type: "text",
        label: __("User registration SMS pattern code:", "wpstorm-notify"),
      },
      aff_user_new_ref: {
        value: "",
        hasErrors: false,
        ...
        type: "checkbox",
        label: __("Send sms to user on new referral:", "wpstorm-notify"),
      },
      aff_user_new_ref_pattern: {
        ...
        type: "text",
        label: __("New referral SMS pattern code:", "wpstorm-notify"),
      },
      ...
      aff_admin_user_register: {
        ...
        type: "checkbox",
        label: __("Send sms to admin on registration:", "wpstorm-notify"),
        groupTitle: __("Admin settings:", "wpstorm-notify"),
      },
      ...
      aff_admin_user_new_ref: {
        ...
        type: "checkbox",
        label: __("Send sms to admin on new referral:", "wpstorm-notify"),
      },
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/aff_options";
