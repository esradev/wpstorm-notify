...
function Settings() {
  ...
  const originalState = {
    inputs: {
      welcome_sms: {
        ...
        type: "checkbox",
        label: __(
          "Send a welcome sms after sing up to the user?",
          "wpstorm-notify"
        ),
      },
      welcome_sms_use_pattern: {
        ...
        type: "checkbox",
        label: __("Send welcome sms after sing up via pattern?", "wpstorm-notify"),
      ...
      welcome_sms_pattern: {
        ...
        type: "text",
        label: __("Welcome sms after sing up pattern code:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __("%display_name% and %username%", "wpstorm-notify"),
        isDependencyUsed: false,
      },
      welcome_sms_msg: {
        value: "",
        ...
        type: "textarea",
        label: __("Welcome message after sing up:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __("%display_name% and %username%", "wpstorm-notify"),
        isDependencyUsed: false,
      },
      ...
      select_roles: {
        ...
        name: "select_roles",
        type: "select",
        label: __("Select rule(s):", "wpstorm-notify"),
        options: [],
      ...
      admin_login_notify_pattern: {
        ...
        type: "text",
        label: __("Notify admin pattern code:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __(
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("Login Notify", "wpstorm-notify"),
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/login_notify_options";
  ...
  useEffect(() => {
     ...
     * @since 1.0.0
     */
    const rolesObject = wpstormNotifyJsObject.wproules.role_names;
