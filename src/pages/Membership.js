...
function Membership(props) {
    ...
    inputs: {
      ...(props.integratedPlugins.indeedMembershipPro.use && {
        ...
        ihc_first_notify_msg: {
          ...
          type: "textarea",
          label: __("Membership expiration warning SMS text:", "wpstorm-notify"),
      ...
      ...(props.integratedPlugins.paidMembershipsPro.use && {
        pmp_send_expire_notify: {
          ...
          type: "checkbox",
          label: __("Send sms membership expiration?", "wpstorm-notify"),
          groupTitle: __("Paid Membership PRO plugin settings:", "wpstorm-notify"),
        },
        pmp_expire_notify_msg: {
          ...
          type: "textarea",
          label: __(
            "The text of the membership expiration SMS:",
            "wpstorm-notify"
          ),
          infoTitle: __("Usable variables:", "wpstorm-notify"),
          infoBody: __("username %display_name%", "wpstorm-notify"),
        },
      }),
    },
    isFetching: true,
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/membership_options";
