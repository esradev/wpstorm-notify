...
function Settings() {
  ...
  const originalState = {
    inputs: {
      apikey: {
        ...
        name: "apikey",
        type: "text",
        placeholder: __("API key", "wpstorm-notify"),
        label: __("Your API key:", "wpstorm-notify"),
        required: true,
        rules: "apikeyRules",
        checkCount: 0,
        tooltip: __(
          "To get the access key in your wpstorm-notify panel, refer to the web service menu in the access keys section",
          "wpstorm-notify"
        ),
      },
      username: {
        ...
        name: "username",
        type: "text",
        placeholder: __("Username", "wpstorm-notify"),
        label: __("Username", "wpstorm-notify"),
        required: true,
        rules: "usernameRules",
        checkCount: 0,
      },
      password: {
        ...
        name: "password",
        type: "text",
        placeholder: __("Password", "wpstorm-notify"),
        label: __("Password", "wpstorm-notify"),
        required: true,
        rules: "passwordRules",
        checkCount: 0,
      },
      admin_number: {
        ...
        name: "admin_number",
        type: "text",
        placeholder: __("Admin Number", "wpstorm-notify"),
        label: __("Admin Number", "wpstorm-notify"),
        required: true,
      ...
      from_number: {
        ...
        label: __("Sender number", "wpstorm-notify"),
      ...
      from_number_adver: {
        ...
        noOptionsMessage: __("No options is available", "wpstorm-notify"),
        label: __("Advertising sender number", "wpstorm-notify"),
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("General", "wpstorm-notify"),
    ippanelUsername: "",
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/settings_options";
      ...
      async function validateApikey() {
        ...
        try {
          const validateApikey = await AxiosWp.post(
            "/wpstorm-notify/v1/validate_apikey",
  ...
  useEffect(() => {
    async function getLines() {
      try {
        const response = await AxiosWp.post("/wpstorm-notify/v1/get_lines", {
