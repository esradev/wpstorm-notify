...
function Woocommerce(props) {
  ...
  const originalState = {
    inputs: {
      ...
      woo_checkout_otp_pattern: {
        ...
        type: "text",
        label: __("Mobile number verification pattern code:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __("The verification code variable is %code%", "wpstorm-notify"),
      ...
      woo_poll_time: {
        ...
        type: "text",
        label: __(
          "Days of sending SMS after placing the order:",
          "wpstorm-notify"
        ),
        isDependencyUsed: false,
      },
      woo_poll_msg: {
        ...
        name: "woo_poll_msg",
        type: "textarea",
        label: __("Message content:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __(
      ...
      woo_tracking_pattern: {
        ...
        type: "text",
        label: __("Pattern code to send tracking code:", "wpstorm-notify"),
        infoTitle: __("Usable variables:", "wpstorm-notify"),
        infoBody: __(
    ...
    isSaving: false,
    sendCount: 0,
    sectionName: __("Woocommerce", "wpstorm-notify"),
  };
   ...
   * @since 1.0.0
   */
  const endpoint = "/wpstorm-notify/v1/woocommerce_options";
